        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden">
                <div className="p-6">
                    ...
                    <h3 className="text-text-dark font-bold text-lg mb-1">Sign out?</h3>
                    <p className="text-neutral-gray text-sm">You will be signed out of all CediBites staff portals on this device.</p>
                </div>
