...
const BANNERS = [
    {
        ...
        headline: 'Order before 2PM',
        subheadline: 'Get free delivery on any combo',
        cta: 'Order Now',
        accent: '#e49925',       // primary
        bg: '#372b1e',           // brown
        pattern: 'diagonal',
    },
    {
        ...
        subheadline: 'Fufu & Light Soup combo — only this Saturday',
        cta: 'Grab the Deal',
        accent: '#6c833f',       // secondary
        bg: '#1d1a16',           // brand-dark
        pattern: 'dots',
    },
    {
        id: 3,
        ...
        headline: 'First Order Free',
        subheadline: 'New to CediBites? Delivery is on us',
        cta: 'Try It Now',
        accent: '#e49925',
        bg: '#120f0d',           // brand-darker
        pattern: 'circles',
    },
    {
        id: 4,
        ...
        headline: 'Tuo Zaafi is here',
        subheadline: `'Northern Ghana's finest — now on our menu`,
        cta: 'See Menu',
        accent: '#f1ab3e',       // primary-hover
        bg: '#372b1e',
        pattern: 'diagonal',
    },
];
