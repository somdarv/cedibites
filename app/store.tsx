        ...
        <div className='flex gap-3 w-ful overflow-x-auto no-scrollbar my-1 lg:my-3  pb-1'>
            {HeroSearchCategoryItems.map((item) => (
                ...
                <button
                    ...
                    className={`cursor-pointer  shrink-0 px-4 py-2 rounded-full text-sm font-medium text-text-dark dark:text-text-light transition-all border border-neutral-gray/50
